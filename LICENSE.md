...
Any use that is not a Permitted Purpose is a Competing Use and is prohibited
without a separate commercial license from us. In particular, offering the
Software (or a substantially similar product) to third parties as a hosted or
managed service is a Competing Use.
...
## Plain-language summary (not a substitute for the license)

- ✅ Use swarmy for almost anything — internally, commercially, for your own apps
  and your clients' apps, modify it, self-host it.
- ❌ You may **not** offer swarmy (or a substantially similar product) to others
  as a competing hosted/managed service without a commercial agreement.
- ⏳ Each released version becomes **Apache-2.0** two years after its release.
- 💼 Enterprise features and the official swarmy Cloud are offered by the swarmy
  team. Want to resell or host commercially? Talk to us.

> This summary and the FSL text above are provided for convenience. Before
> relying on it, have it reviewed by your own legal counsel. Canonical FSL text:
> https://fsl.software
