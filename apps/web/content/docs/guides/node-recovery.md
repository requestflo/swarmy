---
title: "Node recovery and the swarmy-agent CLI"
description: "What to do when a node will not come back online: the repair one-liner, doctor, and rescue backups."
---
