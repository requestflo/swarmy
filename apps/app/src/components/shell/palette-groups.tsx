...
import { CommandGroup, CommandItem, CommandSeparator } from '@swarmy/ui';
...
/**
 * ⌘K's jump list: actions, the seven rows and their pages, live apps /
 * services / servers, and the depth for this page or by default. Mounted only
 * while the palette is open.
 */
export function PaletteGroups({ apps, close }: { apps: string[]; close: () => void }): React.JSX.Element {
