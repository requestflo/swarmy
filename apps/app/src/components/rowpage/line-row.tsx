...
export function LineRow({
  ...
  const cls = '@container border-border flex min-h-14 items-start gap-3 border-b px-1 py-2.5 last:border-b-0 rounded-sm outline-none focus-visible:ring-2 focus-visible:ring-ring/50';
  return to ? (
