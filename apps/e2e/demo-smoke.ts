...
const routes: Array<[string, RegExp?]> = [
  ...
  ['/stacks/storefront/config/scaling'],
  ['/stacks/storefront/config/rollout'],
  ['/stacks/storefront/config/placement'],
  ['/stacks/storefront/config/jobs'],
  ['/stacks/storefront/source'],
